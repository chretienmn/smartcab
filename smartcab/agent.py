...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5, a=.01):
        ...
        self.t = 0   # Number of trials. Incremented by self.reset()
        self.a = a  # Controls how rapidly epsilon increases
...
def run():
    ...
    sim.run(tolerance=.02, n_test=50)
